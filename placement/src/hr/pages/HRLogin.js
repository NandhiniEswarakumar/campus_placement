...
const HRLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await hrApi.login(form.email, form.password);
      hrApi.saveAuth(data.token, data.hr);
          ...
          <div className="sp-auth__brand-content">
            ...
            <div className="sp-auth__brand-features">
              <div className="sp-auth__brand-feature">
                ...
                <span>Post jobs & manage openings</span>
              </div>
              <div className="sp-auth__brand-feature">
                <span className="sp-auth__brand-dot" />
              ...
              <div className="sp-auth__brand-feature">
                <span className="sp-auth__brand-dot" />
                <span>Track recruitment pipeline</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="sp-auth__form-panel">
          <form className="sp-auth__form" onSubmit={handleSubmit} noValidate>
            <div className="sp-auth__form-header">
              <h2 className="sp-auth__form-title">HR Sign In</h2>
              <p className="sp-auth__form-desc">Access your recruitment dashboard</p>
            </div>
            ...
            <div className="sp-auth__field">
              <label htmlFor="hr-login-email" className="sp-auth__label">Email address</label>
            ...
            <div className="sp-auth__field">
              <label htmlFor="hr-login-password" className="sp-auth__label">Password</label>
              <div className="sp-auth__input-wrap">
            ...
            <p className="sp-auth__footer-text">
              ...
              <Link to="/hr/signup" className="sp-auth__link">Register as HR</Link>
            </p>
